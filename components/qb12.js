...
window.QUESTIONNAIRE.Qb12 = (() => {
    ...
    Component.prototype.renderQb = (Component) => {
        const qbTemplate = 
                `<div class="qb">
                    <h2 class="qb-header">Якщо підсумувати Ваші враження від участі у судових провадженнях за останні роки то, чи погоджуєтесь Ви з наступними твердженнями:</h2>
